<template>
        ...
        <div class="max-w-[1200px] mx-auto px-4">
            <div class="md:flex gap-4 justify-between w-full">
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-lg font-semibold text-[#282828] mt-5">Browse Category</div>
                    <div class="text-[#999999] text-sm">
                ...
                <div class="md:w-[50%] pt-4">
                    ...
                    <div class="text-[#999999] text-sm">
                        Alibaba Group Website, AliExpress, Alimama, Alipay, Fliggy, Alibaba Cloud, Alibaba International, AliTelecom, DingTalk, 
                        Juhuasuan, Taobao Marketplace, Tmall, Taobao Global, AliOS, 1688
                    </div>
                    <div class="text-lg font-semibold text-[#282828] mt-20">Alibaba Group</div>
                    <div class="text-[#999999] text-sm">
                        Rusian, Portuguese, Spanisg, French, German, Italian, Dutch, Terkey
                    </div>
                </div>
    ...
    <div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400 mt-10" >
        <div class="max-w-[1200px] max-auto p-4">
            
        Intellectual Property Protection - Privacy Policy - Sitemap - Terms of Use - Information for EU consumers - Imprint - Transaction Services Agreement for non-EU/UK Consumers - 
        Terms and Conditions for EU/EEA/UK Consumers - User Information Legal Enquiry Guide ©️2010-2024 AliExpress.com. All rights reserved. 增值电信业务经营许可证 增值电信业务经营许可证 浙B2-20120091-8 浙公网安备 浙公网安备 33010802002248号
